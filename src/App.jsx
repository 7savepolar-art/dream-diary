  ...
  const StatsView = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow">
          <h3 className="font-bold text-lg mb-4">전체 활동 요약</h3>
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              <div className="text-3xl font-bold text-blue-600">{entries.length}</div>
              <div className="text-sm text-gray-600 mt-1">전체 기록</div>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-3xl font-bold text-green-600">{goals.length}</div>
              <div className="text-sm text-gray-600 mt-1">전체 목표</div>
            </div>
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <div className="text-3xl font-bold text-purple-600">
                {Object.keys(habitChecks).filter(k => habitChecks[k]).length}
              </div>
              <div className="text-sm text-gray-600 mt-1">총 실천 횟수</div>
            </div>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-gray-600">데이터를 불러오고 있습니다</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-6 shadow-lg">
        ...
        <p className="text-purple-100 mt-1">매일의 노력이 마법이 됩니다</p>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex gap-1 overflow-x-auto">
            {[
              ...
              { id: 'habits', name: '📝 학습 습관', icon: CheckCircle },
              { id: 'goals', name: '🎯 목표 관리', icon: Target },
              { id: 'portfolio', name: '📚 포트폴리오', icon: BookOpen },
      ...
      <footer className="bg-white border-t mt-12 py-6 text-center text-gray-600 text-sm">
        <p>💫 꿈을 향한 여정을 응원합니다</p>
        <p className="text-xs text-gray-400 mt-2">Google Analytics 준비 완료</p>
      </footer>
    </div>
  );
}